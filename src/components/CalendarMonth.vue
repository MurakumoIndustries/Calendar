    ...
    <div class="h-100 d-flex flex-column">
        <div class="row">
            <div class="col-auto text-start">
                <a class="btn btn-outline-secondary p-0 m-2" :href="'#!' + prevMonth">
            ...
            <div class="col-auto text-end">
                <a class="btn btn-outline-secondary p-0 m-2" :href="'#!' + nextMonth">
...
export default {
    ...
    computed: {
        ...
        ...mapState(useStore, ["year", "month", "day", "firstDayOfWeek", "prevMonth", "nextMonth"]),
    ...
    methods: {
        ...
        openDetail: function (row, col, index) {
            ...
            this.currentActressId = this.actressList[row][col][index].id;
        }
    },
    components: {}
};
